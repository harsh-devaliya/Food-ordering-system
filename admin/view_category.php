...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Categories / All Category</li>
    </ol>
    <div class="row">
        <div class="col-12">
            <!-- Where user clicks on delete button, Reload only the table content -->
            <div class="card mb-4" id="fetchCategoryData">
                <div class="card-body">
                    <div class="clearfix d-flex">
                        ...
                        <div class="col-6">
                            <a href="add_category.php" class="btn btn-warning float-end">Add Category</a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $retrieve_data_query = "SELECT * FROM categories ORDER BY cat_id DESC";

                                    if(isset($_GET['search']) && !empty($_GET['search']))
                                    {
                                        $searchdata = $_GET['search'];
                                        $retrieve_data_query = "SELECT * FROM categories WHERE CONCAT(cat_id,name,slug,description) LIKE '%$searchdata%' ";
                                    }
                                    ...
                                    if(mysqli_num_rows($retrieve_data_query_run) > 0)
                                    {
                                        foreach($retrieve_data_query_run as $data)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger delete_category_btn" value="<?= $data['cat_id']; ?>"><i class="fas fa-trash-can"></i></button>
                                                    <a href="edit_category.php?cat_id=<?= $data['cat_id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
